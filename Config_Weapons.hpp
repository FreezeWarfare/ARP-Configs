class WeaponShops {
    //Armory Shops
    class gun {
        name = "Lewie Stewie's Firearms";
        side = "civ";
        conditions = "license_civ_gun";
        items[] = {
            { "ItemGPS", "", 500, 50, "" },
            { "hgun_Pistol_Signal_F", "", 3500, -1, "" },
            { "hgun_Rook40_F", "", 6500, -1, "" },
            { "hgun_Pistol_01_F", "", 7000, -1, "" }, 
            { "hgun_P07_khk_F", "", 7500, -1, "" },
            { "hgun_Pistol_heavy_01_F", "", 8500, -1, "" },
    ...
    class terrorist {
        ...
        side = "civ";
        conditions = "(missionNamespace getVariable ['mav_ttm_var_terrorist', 0]) isEqualTo 1;";
        items[] = {
            { "ItemGPS", "", 500, 50, "" },
...
//Cop Shops
    class cop_basic {
        ...
        items[] = {
            ...
            { "srifle_DMR_07_blk_F", "Stun Sniper", 10000, -1, "call life_coplevel >= 2" },
            { "arifle_MXM_Black_F", "", 12000, -1, "call life_coplevel >= 3" },
            { "srifle_DMR_07_blk_F", "", 14000, -1, "call life_coplevel >= 2" },
            { "arifle_SPAR_03_blk_F", "", 15000, -1, "call life_coplevel >= 5" },
            { "srifle_DMR_03_F", "", 18000, -1, "call life_coplevel >= 6" },
            { "launch_B_Titan_short_F", "Anti-Fuel launcher", 20000, -1, "call life_coplevel >= 4" }
        };
        mags[] = {
            { "30Rnd_9x21_Mag", "", 13, -1, "" },
            { "30Rnd_9x21_Mag_SMG_02", "", 13, -1, "" },
            { "30Rnd_556x45_Stanag", "", 13, -1, "" },
            { "30Rnd_65x39_caseless_mag", "", 20, -1, "" },
            { "20Rnd_650x39_Cased_Mag_F", "", 20, -1, "" },
            { "20Rnd_762x51_Mag", "", 20, -1, "" },
            { "11Rnd_45ACP_Mag", "", 20, -1, "" }
        };
        accs[] = {
    ...
    class cop_advanced {
        ...
        side = "cop";
        conditions = "(missionNamespace getVariable ['mav_ttm_var_advCop', 0]) isEqualTo 1;";
        items[] = {
            { "Binocular", "", 150, 75, "" },
            { "ItemGPS", "", 100, 50, "" },
			{ "ItemMap", "", 100, 50, "" },
            { "HandGrenade_Stone", $STR_W_items_Flashbang, 3700, -1, "call life_coplevel >= 1" },
            ...
            { "arifle_AK12_F", "", 50000, -1, "call life_coplevel >= 6" }
