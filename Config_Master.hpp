...
/* Database Related Settings */
    ...
    saved_virtualItems[] = {"gunpowder", "bandage", "panicbutton", "mushrooms", "uraniumU", "uranium", "LSD", "pdrill", "gpstracker", "tent1", "protest", "goldcoin", "pliers", "airhorn", "megaphone", "lumber", "timber", "barrel", "engine", "plans", "beer", "whiskey", "moonshine", "pepsi", "cocaCola", "monsterEnergy", "doritos", "shittynoodles", "kfc", "zipties", "blindfold", "codeCracker", "cprKit", "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","toolkit", "storagesmall", "storagebig", "keyCard" };   
    ...
    save_vehicle_items[] = { "pdrill", "gpstracker", "tent1", "protest", "goldcoin", "airhorn", "megaphone", "pepsi", "cocaCola", "monsterEnergy", "doritos", "shittynoodles", "kfc", "zipties", "blindfold", "cprKit", "pickaxe","fuelEmpty","fuelFull", "spikeStrip", "lockpick", "defuseKit" };
...
/* System Settings */
    ...
    escapeMenu_timer = 8; //Time required to pass before you can click the abort button in the escape menu.
    ...
    /* Lumber System */
    enable_lumbering = true; //Turn on/off the lumber system
    ...
    gang_upgradeBase = 4000; //The base cost for purchasing additional slots in a gang
    ...
    houseGarage_buyPrice = 100000;
    houseGarage_sellPrice = 35000;
    ...
    revive_fee = 3350; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    hospital_heal_fee = 100; //Fee to heal at a hospital NPC

    /* Paycheck & Bank System Configurations */
    bank_cop = 45000; //Amount of cash in bank for new cops
    bank_civ = 45000; //Amount of cash in bank for new civillians
    bank_med = 45000; //Amount of cash in bank for new medics

    paycheck_cop = 1300; //Payment for cops
    paycheck_civ = 520; //Payment for civillians
    paycheck_med = 1350; //Payment for medics
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_T_LSV_01_armed_F", "O_T_LSV_02_armed_F", "B_G_Offroad_01_armed_F", "B_Boat_Armed_01_minigun_F", "d3s_nemises_next_bocha" };	 //Vehicles that can only be rented and not purchased. (Last only for the session)
    ...
    /* Vehicle Insure Prices */
    vehicle_insurance_multiplier_CIVILIAN = .03;	
